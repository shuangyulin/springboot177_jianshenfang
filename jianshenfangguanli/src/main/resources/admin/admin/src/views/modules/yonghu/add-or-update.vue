        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="会员到期日期" prop="daoqiTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.daoqiTime" label="会员到期日期" prop="daoqiTime">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   daoqiTime: [
                              { required: true, message: '会员到期日期不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
