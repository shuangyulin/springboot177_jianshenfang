<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='jianshenfang'">
                    <el-form-item class="select" v-if="type!='info'"  label="健身房" prop="jianshenfangId">
                        <el-select v-model="ruleForm.jianshenfangId" :disabled="ro.jianshenfangId" filterable placeholder="请选择健身房" @change="jianshenfangChange">
                            <el-option
                                    v-for="(item,index) in jianshenfangOptions"
                                    v-bind:key="item.id"
                                    :label="item.jianshenfangName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='jianshenfang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="健身房名称" prop="jianshenfangName">
                        <el-input v-model="jianshenfangForm.jianshenfangName"
                                  placeholder="健身房名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="健身房名称" prop="jianshenfangName">
                            <el-input v-model="ruleForm.jianshenfangName"
                                      placeholder="健身房名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='jianshenfang' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jianshenfangPhoto" label="健身房照片" prop="jianshenfangPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (jianshenfangForm.jianshenfangPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jianshenfangPhoto" label="健身房照片" prop="jianshenfangPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.jianshenfangPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jianshenfang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="健身房位置" prop="jianshenfangAddress">
                        <el-input v-model="jianshenfangForm.jianshenfangAddress"
                                  placeholder="健身房位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="健身房位置" prop="jianshenfangAddress">
                            <el-input v-model="ruleForm.jianshenfangAddress"
                                      placeholder="健身房位置" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="性别" prop="sexValue">
                        <el-input v-model="jiaolianForm.sexValue"
            ...
            <input id="jianshenfangId" name="jianshenfangId" type="hidden">
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="上课时间" prop="kechengKaike">
                       <el-input v-model="ruleForm.kechengKaike"
                                 placeholder="上课时间" clearable  :readonly="ro.kechengKaike"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="上课时间" prop="kechengKaike">
                           <el-input v-model="ruleForm.kechengKaike"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="课程介绍" prop="kechengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengContent" label="课程介绍" prop="kechengContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   jianshenfangId: [
                              { required: true, message: '健身房不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `jianshenfang/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.jianshenfangOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            jianshenfangChange(id){
                this.$http({
                    url: `jianshenfang/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jianshenfangForm = data.data;
                    }
                });
            },
            jiaolianChange(id){
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.jianshenfangChange(data.data.jianshenfangId)
